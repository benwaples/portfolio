...
export const alchemyNetworkr = {
  ...
  description: 'Alchemy Networkr, built in a 1 week remote sprint, is a social network for code school students to find and collaborate on projects. Built in Node.js with an Express API, Postgres Database, and Pug.js server side rendering. This app features the Github API, Jest testing framework, and integrated SSO.',
